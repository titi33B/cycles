...
class HandleCollisionsAction(Action):
    ...
    def _handle_segment_collision(self, cast):
        ...
        Args:
            cast (Cast): The cast of Actors in the game.
        """
        # TODO - you'll have to write the code to get cycle2, then use the collision check
        # in line 66 as a template to write code that will check for collision not only with 
        # the tails, but with the heads of the cycles, too.
